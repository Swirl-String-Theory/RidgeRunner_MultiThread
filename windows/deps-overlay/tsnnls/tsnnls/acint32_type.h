...
/* Prefer int: OpenBLAS/LAPACKE use lapack_int == int32_t == int.
   (On Win64 both int and long are 4 bytes, but they are distinct types.) */
...
/* Fallback for unusual ABIs where only long int is 32-bit. */
